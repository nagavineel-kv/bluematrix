...
import { AlertCircle, AlertOctagon, AlertTriangle, Briefcase, ChevronDownIcon, ChevronUpIcon, Home, Icon, Layers3, LockIcon, LucideIcon, Search, Settings, ShieldAlert, User, Users, X } from 'lucide-react';
...
const Sidebar = () => {
  ...
  return (
    <div className={sidebarClassNames}>
        <div className='flex h-[100%] w-full flex-col jutify-start'>
            {/**Top Logo */}
            ...
            <div className='flex items-center gap-5 border-y-[1.5px] border-gray-200 px-8 py-4 dark:border-gray-700'>
               ...
               <div>
                  <h3 className='text-md font-bold tracking-wide dark:text-gray-200'>Yuveda Systems</h3>
